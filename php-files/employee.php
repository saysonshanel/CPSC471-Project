...
$units_sold = "SELECT COUNT(*) as 'total', SUM(PRICE) AS 'sum' FROM sell, vehicles WHERE sell.eid = 13 AND sell.VIN = vehicles.VIN";
...
<table style="width:100%">
   ...
   $emp_sales = "SELECT * FROM sell, vehicles, purchase, customer WHERE sell.eid = 13 AND purchase.CSIN = customer.Sin AND sell.vin = purchase.VIN AND sell.vin = vehicles.VIN";
