...
CREATE TABLE `Purchase` (
  ...
  CONSTRAINT `csin` FOREIGN KEY (`CSIN`) REFERENCES `customer` (`Sin`),
  CONSTRAINT `vin` FOREIGN KEY (`VIN`) REFERENCES `vehicles` (`VIN`)
...
--
INSERT INTO `purchase` VALUES (900000000,10002,111111),(900000005,10006,111112);
